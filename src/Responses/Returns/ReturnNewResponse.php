...
use Getivy\Responses\Returns\ReturnNewResponse\Currency;
use Getivy\Responses\Returns\ReturnNewResponse\Status;

final class ReturnNewResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new ReturnNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ReturnNewResponse::with(
     *   id: ...,
     *   amount: ...,
     *   createdAt: ...,
     *   currency: ...,
