...
use Getivy\Responses\Banks\BankGetResponse\Capability;
use Getivy\Responses\Banks\BankGetResponse\Currency;
use Getivy\Responses\Banks\BankGetResponse\Market;
use Getivy\Responses\Banks\BankGetResponse\SupportedPaymentScheme;

final class BankGetResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new BankGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BankGetResponse::with(
     *   id: ...,
     *   currencies: ...,
     *   default: ...,
     *   market: ...,
