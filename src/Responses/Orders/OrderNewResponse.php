...
use Getivy\Responses\Orders\OrderNewResponse\BillingAddress;
use Getivy\Responses\Orders\OrderNewResponse\ClimateActionMode;
use Getivy\Responses\Orders\OrderNewResponse\Destination;
use Getivy\Responses\Orders\OrderNewResponse\LineItem;
use Getivy\Responses\Orders\OrderNewResponse\Mandate;
use Getivy\Responses\Orders\OrderNewResponse\MerchantFinancialAddress;
use Getivy\Responses\Orders\OrderNewResponse\PayerFinancialAddress;
use Getivy\Responses\Orders\OrderNewResponse\PaymentMethodType;
use Getivy\Responses\Orders\OrderNewResponse\PaymentMode;
use Getivy\Responses\Orders\OrderNewResponse\PaymentStatus;
use Getivy\Responses\Orders\OrderNewResponse\Price;
use Getivy\Responses\Orders\OrderNewResponse\Refund;
use Getivy\Responses\Orders\OrderNewResponse\ShippingAddress;
use Getivy\Responses\Orders\OrderNewResponse\Shopper;
use Getivy\Responses\Orders\OrderNewResponse\Status;
use Getivy\Responses\Orders\OrderNewResponse\StatusClassification;
use Getivy\Responses\Orders\OrderNewResponse\StatusHistoryList;

final class OrderNewResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new OrderNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * OrderNewResponse::with(
     *   id: ...,
     *   appID: ...,
