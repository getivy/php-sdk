...
use Getivy\Responses\Orders\OrderExpireResponse\LineItem;
use Getivy\Responses\Orders\OrderExpireResponse\Mandate;
use Getivy\Responses\Orders\OrderExpireResponse\MerchantFinancialAddress;
use Getivy\Responses\Orders\OrderExpireResponse\PayerFinancialAddress;
use Getivy\Responses\Orders\OrderExpireResponse\PaymentMethodType;
use Getivy\Responses\Orders\OrderExpireResponse\PaymentMode;
use Getivy\Responses\Orders\OrderExpireResponse\PaymentStatus;
use Getivy\Responses\Orders\OrderExpireResponse\Price;
use Getivy\Responses\Orders\OrderExpireResponse\Refund;
use Getivy\Responses\Orders\OrderExpireResponse\ShippingAddress;
use Getivy\Responses\Orders\OrderExpireResponse\Shopper;
use Getivy\Responses\Orders\OrderExpireResponse\Status;
use Getivy\Responses\Orders\OrderExpireResponse\StatusClassification;
use Getivy\Responses\Orders\OrderExpireResponse\StatusHistoryList;

final class OrderExpireResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new OrderExpireResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * OrderExpireResponse::with(
     *   id: ...,
     *   appID: ...,
