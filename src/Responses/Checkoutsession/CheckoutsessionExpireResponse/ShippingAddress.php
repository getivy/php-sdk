...
use Getivy\Responses\Checkoutsession\CheckoutsessionExpireResponse\ShippingAddress\Country;

final class ShippingAddress implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new ShippingAddress()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ShippingAddress::with(
     *   city: ...,
     *   country: ...,
     *   firstName: ...,
     *   lastName: ...,
