...
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\LineItem;
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\Locale;
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\Mandate;
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\Market;
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\Merchant;
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\PaymentMode;
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\PaymentSchemeSelection;
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\Price;
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\Required;
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\ShippingAddress;
use Getivy\Responses\Checkoutsession\CheckoutsessionNewResponse\Status;

final class CheckoutsessionNewResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new CheckoutsessionNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CheckoutsessionNewResponse::with(
     *   id: ...,
     *   appID: ...,
     *   created: ...,
     *   displayID: ...,
     ...
     *
     * ```
     * (new CheckoutsessionNewResponse)
     *   ->withID(...)
     *   ->withAppID(...)
     *   ->withCreated(...)
     *   ->withDisplayID(...)
