...
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\AvailableMarket;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\BillingAddress;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\Customer;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\LineItem;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\Locale;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\Mandate;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\Market;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\Merchant;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\PaymentMode;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\PaymentSchemeSelection;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\Price;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\Required;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\ShippingAddress;
use Getivy\Responses\Checkoutsession\CheckoutsessionGetResponse\Status;

final class CheckoutsessionGetResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new CheckoutsessionGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CheckoutsessionGetResponse::with(
     *   id: ...,
     *   appID: ...,
     *   created: ...,
     *   displayID: ...,
     ...
     *
     * ```
     * (new CheckoutsessionGetResponse)
     *   ->withID(...)
     *   ->withAppID(...)
     *   ->withCreated(...)
     *   ->withDisplayID(...)
