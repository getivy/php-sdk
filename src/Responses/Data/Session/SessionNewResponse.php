...
use Getivy\Responses\Data\Session\SessionNewResponse\Prefill;
use Getivy\Responses\Data\Session\SessionNewResponse\Status;

final class SessionNewResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new SessionNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SessionNewResponse::with(
     *   id: ...,
     *   availableMarkets: ...,
     *   createdAt: ...,
