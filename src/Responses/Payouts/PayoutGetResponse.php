...
use Getivy\Responses\Payouts\PayoutGetResponse\Currency;
use Getivy\Responses\Payouts\PayoutGetResponse\Destination;
use Getivy\Responses\Payouts\PayoutGetResponse\Status;
use Getivy\Responses\Payouts\PayoutGetResponse\Type;

final class PayoutGetResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new PayoutGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PayoutGetResponse::with(
     *   id: ...,
     *   amount: ...,
     *   createdAt: ...,
     *   currency: ...,
