...
use Getivy\Responses\Mandates\MandateLookupResponse\Creditor;
use Getivy\Responses\Mandates\MandateLookupResponse\Debtor;
use Getivy\Responses\Mandates\MandateLookupResponse\Signature;
use Getivy\Responses\Mandates\MandateLookupResponse\Status;

final class MandateLookupResponse implements BaseModel
{
    use SdkModel;
    ...
    /**
     * `new MandateLookupResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MandateLookupResponse::with(
     *   id: ...,
     *   creditor: ...,
     *   debtor: ...,
     *   reference: ...,
