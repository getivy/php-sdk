...
use Getivy\Checkoutsession\CheckoutsessionCreateParams;
...
use Getivy\Checkoutsession\CheckoutsessionExpireParams;
use Getivy\Checkoutsession\CheckoutsessionRetrieveParams;
use Getivy\Client;
use Getivy\Contracts\CheckoutsessionContract;
...
final class CheckoutsessionService implements CheckoutsessionContract
{
    ...
    public function create(
        ...
        $args = [
            ...
            'paymentSchemeSelection' => $paymentSchemeSelection,
            'prefill' => $prefill,
        ...
        $resp = $this->client->request(
            method: 'post',
            path: 'api/service/checkout/session/create',
            body: (object) $parsed,
            options: $options,
        );

        // @phpstan-ignore-next-line;
        return Conversion::coerce(CheckoutsessionNewResponse::class, value: $resp);
    }
    ...
    public function retrieve(
        ...
        $args = ['id' => $id];
        [$parsed, $options] = CheckoutsessionRetrieveParams::parseRequest(
            $args,
            $requestOptions
        );
        $resp = $this->client->request(
            method: 'post',
            path: 'api/service/checkout/session/details',
            body: (object) $parsed,
            options: $options,
        );

        // @phpstan-ignore-next-line;
        return Conversion::coerce(CheckoutsessionGetResponse::class, value: $resp);
    }
    ...
    public function expire(
        ...
        $args = ['id' => $id];
        [$parsed, $options] = CheckoutsessionExpireParams::parseRequest(
            $args,
            $requestOptions
        );
        $resp = $this->client->request(
            method: 'post',
            path: 'api/service/checkout/session/expire',
            body: (object) $parsed,
            options: $options,
        );
        ...
        return Conversion::coerce(
            CheckoutsessionExpireResponse::class,
            value: $resp
        );
    }
}
